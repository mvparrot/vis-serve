...
```{r landingcountours function, echo=TRUE, cache=FALSE}
```
...
```{r landing_contours4gameskde, echo=FALSE, cache=FALSE, fig.width = 9, fig.height = 5, dpi = 288, fig.align= "center", fig.cap = "Landing positions based on serve and serve number using kde2d with limits"}
ContourLimits(plot_perserve, argument1 = "serve_num", min_games = 4, plot = TRUE)
```


```{r landing_contours3gameskde, echo=FALSE, cache=FALSE, fig.width = 9, fig.height = 5, dpi = 288, fig.align= "center", fig.cap = "Landing positions based on serve and serve number using kde2d with limits"}
plotall <-  ContourLimits(plot_perserve, argument1 = "serve_num", min_games = 3, plot = FALSE)
plotall + facet_wrap(serve_num ~ server)
```

```{r landing_contoursinteresting, echo=FALSE, cache=TRUE}
...
```{r speed_games4_landinghex_contour_num, echo=FALSE, cache=FALSE, fig.width = 9, fig.height = 5, dpi = 288, fig.align= "center", fig.cap = "Landing positions based on serve and serve number using kde2d with limits"}
...
```{r speed_games4_landingpoint_contour_num, echo=FALSE, cache=FALSE, fig.width = 9, fig.height = 5, dpi = 288, fig.align= "center", fig.cap = "Landing positions based on serve and serve number using kde2d with limits"}
plotall <- ContourLimits(plot_perserve, argument1 = "serve_num", min_games = 4, plot = FALSE)
plot_multiple_games <- MultipleGames(4)
plot_gg <- plot_perserve %>% filter(server %in% plot_multiple_games$server, serve_classname != "Fault")
plotall +
