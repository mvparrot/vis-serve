...
\begin{center}\includegraphics{vis-serve-article_files/figure-latex/landing_contoursinteresting-1} \end{center}
...
{\centering \includegraphics{vis-serve-article_files/figure-latex/speed_allsidenumspeed-1} 
